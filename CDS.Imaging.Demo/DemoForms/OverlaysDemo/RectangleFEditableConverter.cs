...
/// <summary>
/// Provides a type converter to convert <see cref="RectangleFEditable"/> objects to and from a string representation.
/// This is useful for properties in the property grid.
/// </summary>
public class RectangleFEditableConverter : ExpandableObjectConverter
{
    /// <summary>
    ...
    {
        if (destinationType == typeof(string) && value is RectangleFEditable rect)
        {
    ...
    public override object? ConvertFrom(ITypeDescriptorContext? context, CultureInfo? culture, object value)
    {
        if (value is string s)
        {
            ...
            {
                return new RectangleFEditable(x, y, width, height);
            }
        }
