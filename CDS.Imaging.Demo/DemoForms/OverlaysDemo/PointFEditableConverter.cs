...
/// <summary>
/// Provides a type converter to convert <see cref="PointFEditable"/> objects to and from a string representation.
/// This is useful for properties in the property grid.
/// </summary>
public class PointFEditableConverter : ExpandableObjectConverter
{
    /// <summary>
    ...
    {
        if (destinationType == typeof(string) && value is PointFEditable point)
        {
