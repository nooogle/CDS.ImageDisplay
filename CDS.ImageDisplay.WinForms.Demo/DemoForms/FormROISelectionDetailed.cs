...
internal sealed partial class FormROISelectionDetailed : Form
{
    ...
    /// </summary>
    private void singleROIManager_OnCommittedROIChanged(object sender, WinForms.RegionOfInterest.CommittedROIChangedEventArgs e)
    {
        var roi = e.ROI;
    ...
    /// </summary>
    private void singleROIManager_OnDraggingROIChanged(object sender, WinForms.RegionOfInterest.DraggingROIChangedEventArgs e) => UpdateROILabels();
}
