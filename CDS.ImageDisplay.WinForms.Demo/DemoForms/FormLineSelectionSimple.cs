...
{
    private readonly WinForms.Overlays.TextShape _committedLineText;
    private readonly WinForms.Overlays.TextShape _draggingLineText;
    private readonly WinForms.Overlays.DrawingSpec _textDrawingSpec;
    ...
    private void bitmapDisplayPanel_OnPaintOver(object sender, WinForms.BitmapDisplay.PaintOverEventArgs e)
    {
        if (e.Graphics is null) { throw new ArgumentNullException(nameof(e.Graphics)); }
