...
internal sealed partial class FormROISelectionSimple : Form
{
    ...
    /// </summary>
    private void singleROIManager_OnCommittedROIChanged(object sender, CDS.ImageDisplay.WinForms.RegionOfInterest.CommittedROIChangedEventArgs e)
    {
        UpdateLabels();
    }
    ...
    /// </summary>
    private void singleROIManager_OnDraggingROIChanged(object sender, CDS.ImageDisplay.WinForms.RegionOfInterest.DraggingROIChangedEventArgs e)
    {
        UpdateLabels();
    }
