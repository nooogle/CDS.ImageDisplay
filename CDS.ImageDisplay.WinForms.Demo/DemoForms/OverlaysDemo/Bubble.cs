...
{
    private readonly WinForms.Overlays.CircleShape shape;
    ...
    internal void Draw(BitmapDisplayPanel bitmapDisplayPanel, Graphics graphics, DrawingSpec drawingSpec) => shape.Draw(bitmapDisplayPanel, graphics, drawingSpec);
}
